...
insert into LOCATION_TABLE (street_name, address_id) values ('20 Salciei', 1);
insert into LOCATION_TABLE (street_name, address_id) values ('3 Victor Babes', 2);
insert into LOCATION_TABLE (street_name, address_id) values ('1 Dimitrie Cantemir', 3);
